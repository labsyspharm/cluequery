...
The API key can be automatically retrieved by all `clueR` functions if it is
...
The `clue_prepare_deseq2` function returns a named vector with paths to the GMT
